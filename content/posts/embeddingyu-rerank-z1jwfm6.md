---
title: Embedding与Rerank
slug: embeddingyu-rerank-z1jwfm6
url: /post/embeddingyu-rerank-z1jwfm6.html
date: '2025-06-07 00:55:23+08:00'
...
embedding我还是比较好理解的, 将内容打成向量, 然后可以在查找时通过 夹角大小/余弦相似度找到最接近的向量, 换言之完成了`相似度`的寻找.
